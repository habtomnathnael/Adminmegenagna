...
const ReservationList = () => {
    const {
        ...
        isError,
        error
    } = useGetReservationsQuery('TableReservationList', {
    ...
    if (isError) {
        ...
        content = (
            <div className=" text-center items-center">
                ...
                <p className="mt-1 text-sm text-gray-500">Get started by adding a new Reservation.</p>
                <div className="mt-6">
                    <button
                        type="button"
                    ...
                    >
                        ...
                        <Link to="/dash/reservations/new">Add New Reservation</Link>
                    </button>
                </div>
            </div>
        )
                    ...
                    <div className="sm:flex sm:items-center">
                        ...
                        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            ...
                            >
                                ...
                                <Link to="/dash/reservation/new">Add New Item</Link>
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                <table className="min-w-full divide-y divide-gray-300">
                                    <thead>
                                        <tr>
                                            <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-600 sm:pl-0">
                                                completed
                                            </th>
                                            <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-600 sm:pl-0">
                                                Customer info
